...
async def stick(event):
    ...
    if reply_message.sender.bot:
        await event.edit("Oups deyəsən bu bir botdur. Bağışla ama hipokratbots andına görə botlardan mesaj və media qəbul etmirəm.")
        return
    ...
    async with event.client.conversation(chat) as conv:
        ...
        if response.text.startswith("Forward"):
            ...
            await event.client.send_file(
                ...
                caption=f"@SpaceUserBot ilə stickerə çevrildi",
            )
    ...
    async with event.client.conversation(chat) as conv:
        ...
        if response.text.startswith("Forward"):
            ...
            await event.client.send_file(
                event.chat_id,
                response.message.media,
                caption=f"Tweet by @SpaceUserBot",
            )
            await event.client.send_read_acknowledge(conv.chat_id)
    ...
    async with event.client.conversation(chat) as conv:
        ...
        if response.text.startswith("Forward"):
            ...
            await event.client.send_file(
                event.chat_id,
                response.message.media,
                caption=f"@SpaceUserBot ilə PNG-yə çevrildi",
            )
            await event.client.send_read_acknowledge(conv.chat_id)
